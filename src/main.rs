...
mod instruction_stuff {
    ...
    const INSTRUCTIONS: [Instruction; 256] = [
    BRK IMPL ; ORA X,IND ; JAM     ; SLO X,IND ; NOP ZPG   ; ORA ZPG   ; ASL ZPG   ; SLO ZPG   ; PHP IMPL ; ORA IMM   ;  ASL A    ; ANC IMM   ; NOP ABS   ; ORA ABS   ; ASL ABS   ; SLO ABS   ;
    ...
    JSR ABS  ; AND X,IND ; JAM     ; RLA X,IND ; BIT ZPG   ; AND ZPG   ; ROL ZPG   ; RLA ZPG   ; PLP IMPL ; AND IMM   ;  ROL A    ; ANC IMM   ; BIT ABS   ; AND ABS   ; ROL ABS   ; RLA ABS   ;
    ...
    RTI IMPL ; EOR X,IND ; JAM     ; SRE X,IND ; NOP ZPG   ; EOR ZPG   ; LSR ZPG   ; SRE ZPG   ; PHA IMPL ; EOR IMM   ;  LSR A    ; ALR IMM   ; JMP ABS   ; EOR ABS   ; LSR ABS   ; SRE ABS   ;
    ...
    RTS IMPL ; ADC X,IND ; JAM     ; RRA X,IND ; NOP ZPG   ; ADC ZPG   ; ROR ZPG   ; RRA ZPG   ; PLA IMPL ; ADC IMM   ;  ROR A    ; ARR IMM   ; JMP IND   ; ADC ABS   ; ROR ABS   ; RRA ABS   ;
    ...
    NOP IMM  ; STA X,IND ; NOP IMM ; SAX X,IND ; STY ZPG   ; STA ZPG   ; STX ZPG   ; SAX ZPG   ; DEY IMPL ; NOP IMM   ;  TXA IMPL ; ANE IMM   ; STY ABS   ; STA ABS   ; STX ABS   ; SAX ABS   ;
    ...
    LDY IMM  ; LDA X,IND ; LDX IMM ; LAX X,IND ; LDY ZPG   ; LDA ZPG   ; LDX ZPG   ; LAX ZPG   ; TAY IMPL ; LDA IMM   ;  TAX IMPL ; LXA IMM   ; LDY ABS   ; LDA ABS   ; LDX ABS   ; LAX ABS   ;
    ...
    CPY IMM  ; CMP X,IND ; NOP IMM ; DCP X,IND ; CPY ZPG   ; CMP ZPG   ; DEC ZPG   ; DCP ZPG   ; INY IMPL ; CMP IMM   ;  DEX IMPL ; SBX IMM   ; CPY ABS   ; CMP ABS   ; DEC ABS   ; DCP ABS   ;
    ...
    CPX IMM  ; SBC X,IND ; NOP IMM ; ISC X,IND ; CPX ZPG   ; SBC ZPG   ; INC ZPG   ; ISC ZPG   ; INX IMPL ; SBC IMM   ;  NOP IMPL ; USBC IMM  ; CPX ABS   ; SBC ABS   ; INC ABS   ; ISC ABS   ;
